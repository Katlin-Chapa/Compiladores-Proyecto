...
codigo_programa
    : (declaracion_variable | instruccion_asignacion | instruccion_if | instruccion_while | instruccion_return | llamada_funcion | instruccion_print | comentario)*
    ;

declaracion_variable
    : tipo IDENT ('=' expresion)? ';' comentario*
    ;
